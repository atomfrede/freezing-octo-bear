...
matetrackerApp.controller('LanguageController', function ($scope, $translate, LanguageService) {
...
matetrackerApp.controller('MenuController', function ($scope) {
    });

matetrackerApp.controller('LoginController', function ($scope, $location, AuthenticationSharedService) {
...
matetrackerApp.controller('LogoutController', function ($location, AuthenticationSharedService) {
        AuthenticationSharedService.logout();
    });

matetrackerApp.controller('SettingsController', function ($scope, Account) {
        $scope.success = null;
        $scope.error = null;
...
matetrackerApp.controller('RegisterController', function ($scope, $translate, Register) {
        $scope.success = null;
        $scope.error = null;
...
matetrackerApp.controller('ActivationController', function ($scope, $routeParams, Activate) {
...
matetrackerApp.controller('PasswordController', function ($scope, Password) {
        $scope.success = null;
        $scope.error = null;
        $scope.doNotMatch = null;
...
matetrackerApp.controller('SessionsController', function ($scope, resolvedSessions, Sessions) {
        $scope.success = null;
        $scope.error = null;
...
matetrackerApp.controller('ConfigurationController', function ($scope, resolvedConfiguration) {
...
matetrackerApp.controller('LogsController', function ($scope, resolvedLogs, LogsService) {
...
matetrackerApp.controller('AuditsController', function ($scope, $translate, $filter, AuditsService) {
