...
@Configuration
@EnableJpaRepositories("de.atomfrede.matetracker.web.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "de.atomfrede.matetracker.web.config.HerokuDatabaseConfiguration")
